#ifndef Optimizer
#define Optimizer
#include "simple_optimizer_Levenberg_Marquardt.h"
#endif

void simpleoptimizer::run_optimize() {
...
bool simpleoptimizer::Levenberg_maarquardt(){
    bool foundFLAG;
    double v = 2;
    double oneThird = 1/3;
    updateJacobian();
...
Eigen::VectorXd simpleoptimizer::linear_solver(
...
double simpleoptimizer::initialLambda(Eigen::SparseMatrix<double,Eigen::RowMajor> H_){
    int size = H_.rows();
...
bool simpleoptimizer::stop_condition(){
    return false;
}
